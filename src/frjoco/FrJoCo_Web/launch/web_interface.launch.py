...
def generate_launch_description():
    ...
    gripper_bridge = Node(
        ...
        executable='gripper_web_bridge.py',
        name='gripper_web_bridge',
        output='screen',
        condition=IfCondition(enable_gripper_bridge),
        parameters=[{
            'command_topic': '/web/gripper_command',
    ...
    return LaunchDescription([
        DeclareLaunchArgument('enable_gripper_bridge', default_value='true'),
        rosbridge_node,
        rosapi_node,
        web_video_node,
        gripper_bridge,
